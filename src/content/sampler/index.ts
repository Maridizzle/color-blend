...
export const SAMPLER_CATEGORIES: Category[] = [
  ...
  },
  {
    id: 'the-weather',
    title: 'The Weather',
    blurb: 'The restless air, and the small daily catastrophes of the sky.',
    subjects: [
      {
        id: 'crepuscular-rays',
        title: 'Crepuscular Rays',
        blurb: 'Shafts of sun through a gap in the cloud, and the trick the eye plays with them.',
        hue: 249,
        artwork: { kind: 'url', url: './artwork/crepuscular-rays.jpg' },
        facts: [
          'The shafts of light that fan out where the sun breaks through cloud are crepuscular rays; the dark bands between them are the shadows of the clouds.',
          'The rays only appear to spread apart. They are very nearly parallel, and the fanning is perspective — the same effect that makes railway lines seem to meet at the horizon.',
          'Rays that seem to converge again on the far side of the sky, opposite the sun, are anticrepuscular rays: the same beams, seen going away.',
          'They are made visible by haze, dust or mist scattering the light. In perfectly clean air the beams would be there but invisible.',
          'The name is from the Latin for twilight, because they are most striking around sunrise and sunset.',
        ],
      },
      {
        id: 'isobars',
        title: 'Isobars',
        blurb: 'The contour lines of the weather, and which way the wind reads them.',
        hue: 357,
        artwork: { kind: 'url', url: './artwork/isobars.jpg' },
        facts: [
          'Isobars join places of equal air pressure. They are the contour lines of a weather map, and the wind reads them like a hillwalker reads contours.',
          'Wind blows almost along the isobars rather than across them, and the closer together they are, the harder it blows.',
          'Air spirals in and rises around a low and sinks and spreads out around a high, which is why lows bring cloud and rain and highs bring settled weather.',
          'In the northern hemisphere the wind turns anticlockwise around a low and clockwise around a high; south of the equator both are reversed.',
          'Pressure is measured in hectopascals, once called millibars. Average sea level is about 1013; the lowest ever measured, inside a Pacific typhoon, was 870.',
        ],
      },
      {
        id: 'green-sky',
        title: 'The Green Sky',
        blurb: 'When a storm turns the light green, and what that warns of.',
        hue: 177,
        artwork: { kind: 'url', url: './artwork/green-sky.jpg' },
        facts: [
          'A severe thunderstorm can turn the whole sky a deep green, most often in the late afternoon before large hail or a tornado.',
          'The colour is real, not a trick of the eye: instruments pointed at these storms have measured green light coming back from them.',
          'The leading explanation is that low, reddened evening sunlight passes through a towering cloud packed with water and ice, which scatters a blue-green light back out.',
          'Green does not by itself mean a tornado. It means the cloud is enormously deep and water-laden, which is the company severe weather keeps.',
          'Across the Great Plains of the United States a green sky has been read as a warning of hail for generations, and it is one of the few weather superstitions that holds up.',
        ],
      },
      {
        id: 'lightning',
        title: 'The Thunderbolt',
        blurb: 'Hotter than the sun, for a millionth of a second.',
        hue: 285,
        artwork: { kind: 'url', url: './artwork/lightning.jpg' },
        facts: [
          'A lightning stroke heats the air around it to about 30,000 kelvin — some five times the surface of the sun — for a few millionths of a second.',
          'That sudden heat makes the air explode outward, and the shock wave, once it slows to the speed of sound, is thunder.',
          'Count the seconds between the flash and the thunder and divide by three for the distance in kilometres: light arrives at once, while sound takes about three seconds to travel one.',
          'The bright bolt you see actually travels upward, a return stroke rushing back up a faint channel that first felt its way down from the cloud.',
          'Lightning strikes the Earth forty to fifty times every second, and a tall, lone object is hit far more often than open ground.',
        ],
      },
      {
        id: 'waterspout',
        title: 'The Waterspout',
        blurb: 'A rope of spinning cloud let down onto the sea.',
        hue: 69,
        artwork: { kind: 'url', url: './artwork/waterspout.jpg' },
        facts: [
          'A waterspout is a spinning column of air over water. Most are not made of seawater at all, but of cloud droplets condensing in the low-pressure core.',
          'Fair-weather spouts build from the surface upward under a growing cloud and are usually mild; tornadic ones descend from a storm and are as dangerous as any tornado.',
          'A spout can lift small fish and frogs from a pond and carry them off, the likely source of centuries of reports of animals falling from the sky.',
          'The moment a waterspout crosses onto land it is reclassified as a tornado.',
          'They are common enough over some warm seas that the Florida Keys alone see hundreds in a year.',
        ],
      },
      {
        id: 'hailstone',
        title: 'The Hailstone',
        blurb: 'Ice with rings like a tree, built on the way up.',
        hue: 105,
        artwork: { kind: 'url', url: './artwork/hailstone.jpg' },
        facts: [
          'A hailstone grows in layers, carried up and down through a storm again and again and gaining a coat of ice each trip. Cut one open and the layers show like the rings of an onion.',
          'It takes a violent updraught to hold a stone aloft while it grows; the largest ride winds of over 150 kilometres an hour before they are finally too heavy to stay up.',
          'Clear layers form where the stone grows wet and the ice freezes slowly and glassily; milky layers form where it grows dry and traps air.',
          'The heaviest hailstone on record fell in Bangladesh in 1986 and weighed about a kilogram.',
          'Hail is a thing of late spring and summer, not winter: it takes a tall, warm-based thunderstorm to build one.',
        ],
      },
      {
        id: 'petrichor',
        title: 'Petrichor',
        blurb: 'The smell of the first rain on dry ground has a name.',
        hue: 141,
        artwork: { kind: 'url', url: './artwork/petrichor.jpg' },
        facts: [
          'Petrichor is the earthy smell of rain on dry ground. The word was coined in 1964 from the Greek for stone and for the ichor said to run in the veins of the gods.',
          'Much of the scent is geosmin, made by soil bacteria; the human nose finds it at a few parts per trillion, more keenly than a shark smells blood.',
          'A raindrop landing on dry, porous ground traps tiny bubbles of air that burst upward as a fine spray, carrying the scent into the air.',
          'The sharp, clean smell that runs ahead of a storm is ozone, made when lightning splits the oxygen in the air and carried down on the storm’s cold draught.',
          'The scent is strongest after a dry spell, when plant oils have built up on the ground and the first rain releases them all at once.',
        ],
      },
      {
        id: 'downpour',
        title: 'The Downpour',
        blurb: 'What shape a raindrop really is, on the way down.',
        hue: 33,
        artwork: { kind: 'url', url: './artwork/downpour.jpg' },
        facts: [
          'Raindrops are not tear-shaped. The small ones are spheres, and the large ones flatten into something like a tiny bun as the air pushes up on them.',
          'A drop cannot grow much past six millimetres across before the rush of air tears it apart into smaller drops.',
          'Most rain in the world begins as snow: ice crystals high in the cloud grow heavy, fall, and melt on the way down.',
          'A big raindrop falls at about nine metres a second; a fine drizzle drifts down many times more slowly.',
          'The wettest inhabited place on Earth, Mawsynram in India, gathers around eleven metres of rain a year, almost all of it in the summer monsoon.',
        ],
      },
      {
        id: 'afterglow',
        title: 'The Afterglow',
        blurb: 'The colour the sky keeps after the sun has gone.',
        hue: 321,
        artwork: { kind: 'url', url: './artwork/afterglow.jpg' },
        facts: [
          'After the sun has set a glow lingers, because sunlight is still striking dust and haze high in the air and scattering back down to the ground.',
          'The rose and purple come from red light arriving from below the horizon mixing with blue light scattered by the high atmosphere.',
          'After a great volcanic eruption the afterglow can burn brighter and last for years, tinted by ash carried around the world; Krakatoa in 1883 lit twilights so red that fire brigades were called out.',
          'The band of pink opposite the sunset, resting on the deep blue of the Earth’s own shadow, is called the Belt of Venus.',
          'A sunset’s colours are not in the cloud. They are the colour the sunlight has become after its long, slanting passage through the air.',
        ],
      },
      {
        id: 'snowfall',
        title: 'Snowfall',
        blurb: 'Six-sided, silent, and mostly air.',
        hue: 213,
        artwork: { kind: 'url', url: './artwork/snowfall.jpg' },
        facts: [
          'No two snowflakes are alike, yet almost every one carries the same six-fold symmetry, set by the way water molecules lock together as they freeze.',
          'Fresh snow is up to about ninety per cent trapped air, which is why it muffles sound and blankets the ground with warmth beneath it.',
          'It can indeed be “too cold to snow” in a sense: very cold air holds little moisture, so the heaviest falls come near freezing, not far below it.',
          'Snow is white though ice is clear, because its countless facets scatter every colour of light back equally.',
          'Deep snow glows faintly blue inside its own hollows: the long red wavelengths are absorbed within a metre or so, and blue light survives to scatter back out.',
        ],
      },
    ],
  },
